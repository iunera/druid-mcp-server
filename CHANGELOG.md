...
### Added
- Added custom Druid health monitoring and actuator support for enhanced observability.

### Changed
- Simplified `listDatasources` tool by removing `UsageTools`.

### Removed
- Removed file-based logging configuration from all YAML files.

Full Changelog: https://github.com/iunera/druid-mcp-server/compare/v1.7.0...v1.8.0
...
[1.5.2]: https://github.com/iunera/druid-mcp-server/compare/v1.5.1...v1.5.2
[1.5.1]: https://github.com/iunera/druid-mcp-server/compare/v1.5.0...v1.5.1
[1.5.0]: https://github.com/iunera/druid-mcp-server/compare/v1.4.0...v1.5.0
