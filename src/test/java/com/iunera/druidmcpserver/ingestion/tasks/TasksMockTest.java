...
class TasksMockTest {
    ...
    void testTaskOperationsWithMockData() {
        ...
        String taskDetails = tasksToolProvider.getTaskRawDetails(taskId);
        ...
        String taskStatus = tasksToolProvider.getTaskStatus(taskId);
        ...
        String ingestionSpec = tasksToolProvider.getTaskIngestionSpec(taskId);
        ...
        String taskReports = tasksToolProvider.getTaskReports(taskId);
        ...
        String taskLog = tasksToolProvider.getTaskLog(taskId);
        ...
        String taskLogWithOffset = tasksToolProvider.getTaskLogWithOffset(taskId, 100);
        ...
        // Test killing task
        String killResult = tasksToolProvider.killTask(taskId);
