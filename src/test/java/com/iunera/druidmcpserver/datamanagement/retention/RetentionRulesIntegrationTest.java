...
class RetentionRulesIntegrationTest {
    ...
    @Autowired
    private RetentionRulesTools retentionRulesTools;
    ...
    void testRetentionRulesToolProviderConfiguration() {
        ...
        String result = retentionRulesTools.viewAllRetentionRules();
    ...
    void testRetentionRulesForSpecificDatasource() {
        ...
        String result = retentionRulesTools.viewRetentionRulesForDatasource(testDatasource);
        assertNotNull(result);
    ...
    void testRetentionRulesEdit() {
        ...
        String result = retentionRulesTools.editRetentionRulesForDatasource(testDatasource, testRules);
        assertNotNull(result);
    ...
    void testRetentionRulesHistory() {
        ...
        String result = retentionRulesTools.viewRetentionRuleHistory(testDatasource);
        assertNotNull(result);
